...
Transformer架構的成功，直接催生了BERT（專注於理解）、GPT（專注於生成）、T5等一系列強大的預訓練語言模型（PLM）。這些模型首先在海量的無標籤文本數據上進行預訓練，學習通用的語言知識，然後可以在特定的下游任務上進行微調（Fine-tuning），只需少量的標籤數據就能達到很好的效果，徹底改變了NLP領域的研究與應用範式。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：NLP三劍客',
        explanation: '• **NLU (懂你心)**: 理解語言的意義。\n• **NLG (說你好)**: 生成自然的文本。\n• **Transformer (看全局)**: 高效處理長距離依賴。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
代表性模型與架構
  ...
  • T5 (Text-to-Text Transfer Transformer): 將所有NLP任務都統一為文本到文本的格式，採用編碼器-解碼器(Encoder-Decoder)完整架構。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：生成AI三巨頭',
        explanation: '• **GAN (真假大師)**: 生成器與判別器互相博弈。\n• **擴散 (去噪畫家)**: 從噪聲中還原出圖像。\n• **LLM (萬卷書生)**: 預測下一個詞，學會全世界。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
代表性任務
  ...
  • 視覺故事生成 (Visual Storytelling): 輸入一系列圖片，模型生成一個連貫的故事情節。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：多模態三板斧',
        explanation: '• **嵌入 (拉近點)**: 將圖文等不同內容，在向量空間中對齊。\n• **融合 (炒一盤)**: 將不同特徵有效結合。\n• **生成 (翻譯一下)**: 將一種模態「翻譯」成另一種。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
一個清晰的ROI預估是爭取管理層支持和評估專案成功與否的重要依據。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：AI導入四問',
        explanation: '1. **為何做 (業務價值)**: 要解決什麼痛點？\n2. **用啥做 (數據基礎)**: 數據夠不夠、好不好？\n3. **能否做 (技術資源)**: 技術、人才、設施到位嗎？\n4. **值得嗎 (投資回報)**: 投入產出划算嗎？'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
AI專案充滿不確定性（數據品質、模型性能等），不適合一開始就規劃一個龐大而完美的系統。
  ...
  • 溝通規劃: 建立定期的、多層次的溝通機制。例如，每日站會（技術團隊內部）、週會（與業務方同步進度）、以及專案儀表板（向管理層展示KPI）。清晰、透明的溝通是管理期望、及時發現問題的關鍵。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：AI規劃四步',
        explanation: '1. **週期 (生命週期)**: 遵循探索、開發、監控的循環。\n2. **團隊 (找對人)**: 組建跨職能的AI三劍客。\n3. **策略 (MVP)**: 小步快跑，快速驗證。\n4. **資源 (錢時人)**: 規劃好預算、時程與溝通。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
指AI系統在部署和維運階段可能遇到的技術和流程問題。
  ...
  • 供應鏈風險: 過度依賴單一的第三方AI服務提供商，一旦該服務中斷或漲價，將對自身業務造成重大衝擊。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：AI風險四維度',
        explanation: '• **模型風險 (不準了)**: 數據漂移、性能衰退。\n• **數據風險 (洩漏了)**: 隱私、安全、合規問題。\n• **倫理風險 (不公了)**: 演算法偏見與歧視。\n• **營運風險 (掛了)**: 系統不穩、監控不足。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
在準備好數據後，需根據多個因素選擇合適的機器學習模型，核心原則是偏差-方差權衡。
  ...
  • 從基準模型開始: 最佳實踐是先從一個簡單、快速的基準模型（Baseline Model）開始，建立性能底線。這不僅能快速驗證整個數據流程，也為後續評估複雜模型的增益提供了參考。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：數據準備四重奏',
        explanation: '1. **清洗 (洗菜)**: 處理缺失、離群、不一致。\n2. **轉換 (切菜)**: 特徵縮放、類別編碼。\n3. **工程 (調味)**: 創造、組合新特徵。\n4. **選擇 (挑菜)**: 篩選最相關的特徵。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
...
MLOps是DevOps在機器學習領域的延伸，它是一套旨在實現機器學習工作流程自動化、標準化和可持續性的文化與實踐。其目標是打通從數據準備、模型訓練、驗證、部署到監控與再訓練的整個閉環，縮短模型從開發到上線的週期，並確保其長期穩定可靠。
  ...
  • 模型監控: **部署後的重中之重**。持續監控已部署模型的運行狀況，不僅包括傳統的系統指標（如API延遲、QPS、CPU/GPU使用率、錯誤率），更重要的是模型性能指標（如預測準確率、預測結果的分佈漂移、輸入特徵的分佈漂移）。一旦指標惡化並超過預設閾值，監控系統應能自動觸發警報，通知相關人員或啟動自動化的再訓練流程。`
    ...
    memoryAids: [
      {
        title: '記憶口訣：部署三模式+α',
        explanation: '• **批次 (隔夜飯)**: 定期大量處理。\n• **即時 (現點現做)**: 隨時單筆回應。\n• **邊緣 (隨身便當)**: 在裝置本地運算。\n• **MLOps (自動化中央廚房)**: 實現持續交付與訓練。'
      },
      {
        title: '挑戰與限制',
        explanation: `技術限制
